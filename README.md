<div align="center">
  <a href="https://v2.nonebot.dev/store">
    <img src="docs/nbp_logo.png" width="180" height="180">
  </a>
  <br>
  <p>
    <img src="docs/nbp.svg" width="240">
  </p>
</div>
...
<p align="center">
  <img src="docs/eg3.png" width="70%">
</p>

<p align="center">
  <img src="docs/eg4.png" width="70%">
</p>

### 用户卡片

<p align="center">
  <img src="docs/eg1.png" width="48%">
  <img src="docs/eg2.png" width="48%">
</p>
...
| 配置项 | 是否必需 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `clist_username` | 是 | 空 | clist.by 用户名 |
| `clist_api_key` | 是 | 空 | clist.by API Key |
| `oj_include` | 否 | `[1,93,163,166,102]` | 默认查询的平台 ID 列表 |
| `algo_days` | 否 | `7` | 近期比赛默认查询天数 |
| `algo_limit` | 否 | `20` | clist.by API 返回数量上限 |
| `algo_remind_pre` | 否 | `30` | 比赛开始前多少分钟提醒 |
| `algo_order_by` | 否 | `start` | clist.by 排序字段 |
...
| 命令 | 功能 | 示例 |
| --- | --- | --- |
| `bindlg [用户名或 ID]` | 绑定洛谷账号 | `bindlg 123456` |
| `mylg` | 查询已绑定洛谷账号的简略卡片 | `mylg` |
| `mylg -f` | 查询已绑定洛谷账号的详细卡片 | `mylg -f` |
| `lg [用户名或 ID]` / `洛谷 [用户名或 ID]` | 查询指定洛谷用户的简略卡片 | `lg 123456` |
| `lg -f [用户名或 ID]` / `洛谷 -f [用户名或 ID]` | 查询指定洛谷用户的详细卡片 | `lg -f 123456` |

### Codeforces

| 命令 | 功能 | 示例 |
| --- | --- | --- |
| `bindcf [handle]` | 绑定 Codeforces 账号 | `bindcf tourist` |
| `mycf` | 查询已绑定 Codeforces 账号的简略卡片 | `mycf` |
| `mycf -f` | 查询已绑定 Codeforces 账号的详细卡片 | `mycf -f` |
| `cf [handle]` | 查询指定 Codeforces 用户的简略卡片 | `cf tourist` |
| `cf -f [handle]` | 查询指定 Codeforces 用户的详细卡片 | `cf -f tourist` |
